...
*/
  ...
  _executeHttpTest: function(test, previousResponse, cb) {
    ...
    if (typeof(reqSpec) === 'function' || typeof(resSpec) === 'function') {
      if (typeof(reqSpec) === 'function') {
        reqSpec = reqSpec.call(test, previousResponse)
      }
      if (typeof(resSpec) === 'function') {
        resSpec = resSpec.call(test, previousResponse)
      }
      return this._executeHttpTest({ reqSpec: reqSpec, resSpec: resSpec },
                                   previousResponse, 
                                   cb)
    }
